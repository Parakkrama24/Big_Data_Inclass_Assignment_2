...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -534130369921414086L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"com.bigdata.kafka.avro\",\"fields\":[{\"name\":\"orderId\",\"type\":\"string\",\"doc\":\"Unique identifier for the order\"},{\"name\":\"product\",\"type\":\"string\",\"doc\":\"Name of the purchased item\"},{\"name\":\"price\",\"type\":\"float\",\"doc\":\"Price of the product\"}]}");
   ...
   */
  public static com.bigdata.kafka.avro.Order.Builder newBuilder() {
    return new com.bigdata.kafka.avro.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.bigdata.kafka.avro.Order.Builder newBuilder(com.bigdata.kafka.avro.Order.Builder other) {
    if (other == null) {
      return new com.bigdata.kafka.avro.Order.Builder();
    } else {
      return new com.bigdata.kafka.avro.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.bigdata.kafka.avro.Order.Builder newBuilder(com.bigdata.kafka.avro.Order other) {
    if (other == null) {
      return new com.bigdata.kafka.avro.Order.Builder();
    } else {
      return new com.bigdata.kafka.avro.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.bigdata.kafka.avro.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.bigdata.kafka.avro.Order other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderId)) {
        this.orderId = data().deepCopy(fields()[0].schema(), other.orderId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bigdata.kafka.avro.Order.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bigdata.kafka.avro.Order.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bigdata.kafka.avro.Order.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bigdata.kafka.avro.Order.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bigdata.kafka.avro.Order.Builder setPrice(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.bigdata.kafka.avro.Order.Builder clearPrice() {
